...
export const slots_List = (data) => {
    return dispatch => {
        dispatch({
            type: ActionTypes.SLOTS_LIST,
            payload: data
        })
    }
}
...
export const SlotsArrAction = (data) => {
    return dispatch => {
        dispatch({
            type: ActionTypes.SLOTS_ARRY,
            payload: data
        })
    }
}
...
export const adminParkingAction = (data) => {
    return dispatch => {
        dispatch({
            type: ActionTypes.ADMIN_PARKING,
            payload: data
        })
    }
}

export const adminParkingActionEmpty = (data) => {
    return dispatch => {
        dispatch({
            type: ActionTypes.ADMIN_PARKING_EMPTY,
            payload: data
        })
    }
}
...
export const FeedbackValAction = (data) => {
    console.log(data)
    return dispatch => {
        dispatch({
            type: ActionTypes.FEEDBACK_VALUE,
            payload: data
        })
    }
}
...
export const FeedbacReplyAction = (data) => {
    console.log(data)
    return dispatch => {
        dispatch({
            type: ActionTypes.FEEDBACK_REPLY,
            payload: data
        })
    }
}
...
export const FeedbacReplyActionEmty = (data) => {
    console.log(data)
    return dispatch => {
        dispatch({
            type: ActionTypes.FEEDBACK_REPLY_EMPY,
            payload: data
        })
    }
}
